...
const ticketSize = 20;
const storeKey = "lecture02-cards-progress-v1";
const langKey = "lecture02-cards-lang";
const app = document.getElementById("app");

const copy = {
  ru: {
    title: "Лекция 2",
    subtitle: "Matplotlib, Seaborn, визуализация данных",
    stats: "Статистика",
    correct: "правильно",
    total: "всего",
    answers: "ответов",
  ...
  en: {
    title: "Lecture 2",
    subtitle: "Matplotlib, Seaborn, data visualization",
    stats: "Statistics",
    correct: "correct",
    total: "total",
    answers: "answers",
